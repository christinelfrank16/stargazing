export class SkyMap {
  ...
  getConstCoords(constellationName){
    return new Promise((resolve,reject) => {
      let request = new XMLHttpRequest();
      const url = `${this.coordsUrl}?object=${constellationName}`;
  ...
  getGroupCoords(ra, de, rotation, angle, maxStars, maxVMag){
    return new Promise((resolve,reject) => {
      let request = new XMLHttpRequest();
      const url = `${this.coordsUrl}/getstars.jsp?ra=${ra}&de=${de}&angle=${angle}&&max_stars=${maxStars}&max_vmag=${maxVMag}`;
  ...
  getStarMapImg(ra, de, rotation){
    return new Promise((resolve,reject) => {
      let request = new XMLHttpRequest();
      const url = this.buildStarMap(ra, de, rotation);
